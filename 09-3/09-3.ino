...
LBLEService ledService("05050075-E8F2-537E-4F6C-D104768A1214");
LBLECharacteristicInt switchCharacteristic("05050075-E8F2-537E-4F6C-D104768A1214", LBLE_READ | LBLE_WRITE);
int led = 1;
void setup() {
  ...
  advertisement.configAsConnectableDevice("孔弘軒");

  // Configure our device's Generic Access Profile's device name
  // Ususally this is the same as the name in the advertisement data.
  LBLEPeripheral.setName("孔弘軒");
